export const BADGE_BACKGROUNDS = {
    ...
    win_streak_5: 'bg-badge--amber',
    win_streak_6: 'bg-badge--amber',
    win_streak_7: 'bg-badge--amber',
    ...
    lose_streak_5: 'bg-badge--brown',
    lose_streak_6: 'bg-badge--brown',
    lose_streak_7: 'bg-badge--brown',
...
export const BADGE_NAMES = {
    ...
    showoff: 'Bigshots',
    win_streak_2: 'Win streak 2',
    win_streak_3: 'Win streak 3',
    win_streak_4: 'Win streak 4',
    win_streak_5: 'Win streak 5',
    win_streak_6: 'Win streak 6',
    win_streak_7: 'Win streak 7',
    win_streak_8: 'Win streak 8',
    win_streak_9: 'Win streak 9',
    win_streak_10: 'Win streak 10',
    lose_streak_2: 'Losing streak 2',
    lose_streak_3: 'Losing streak 3',
    lose_streak_4: 'Losing streak 4',
    lose_streak_5: 'Losing streak 5',
    lose_streak_6: 'Losing streak 6',
    lose_streak_7: 'Losing streak 7',
...
export const BADGE_DESCRIPTIONS = {
    ...
    win_streak_4: 'Win 4 games in a row.',
    win_streak_5: 'Win 5 games in a row.',
    win_streak_6: 'Win 6 games in a row.',
    win_streak_7: 'Win 7 games in a row.',
    win_streak_8: 'Win 8 games in a row.',
    win_streak_9: 'Win 9 games in a row.',
    win_streak_10: 'Win 10 games in a row.',
    lose_streak_2: 'Lose 2 games in a row.',
    lose_streak_3: 'Lose 3 games in a row.',
    lose_streak_4: 'Lose 4 games in a row.',
    lose_streak_5: 'Lose 5 games in a row.',
    lose_streak_6: 'Lose 6 games in a row.',
    lose_streak_7: 'Lose 7 games in a row.',
