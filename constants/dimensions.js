...
const ROCK_DIAMETER_INCHES = 11;
export const ROCK_DIAMETER_PERCENT = 3.28
// export const ROCK_DIAMETER_PERCENT = 6.11
export const ROCK_DIAMETER_PERCENT_X = ROCK_DIAMETER_INCHES / PLAYING_AREA_DIMENSIONS.x * 100;
export const ROCK_DIAMETER_PERCENT_Y = ROCK_DIAMETER_INCHES / PLAYING_AREA_DIMENSIONS.y * 100;