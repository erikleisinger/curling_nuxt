...
const homeName = computed(() => !home.value?.team?.id ? home?.value?.placeholder : home?.value?.team?.name)
const awayName = computed(() => !away.value?.team?.id ? away?.value?.placeholder : away?.value?.team?.name)
</script>
