    ...
    <q-space/>
     ...
     <q-list bordered separator >
         ...
         <q-item-label caption>
            <div class="row"><q-icon name="remove_circle" class="rotate-45 rock__icon q-mr-xs" color="red"/>{{game.away}}</div>
             <div class="row"><q-icon name="remove_circle" class="rotate-45 rock__icon q-mr-xs" color="yellow"/>{{game.home}}</div>
         </q-item-label>
            </q-item-section>
            <q-space/>
            <q-item-section side >
