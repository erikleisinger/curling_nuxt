...
<div class=" global-search__container row justify-center full-width full-height">
    <div class="global-search__inner">
        <AreaSearch :inputLabel="options.inputLabel"  @select="onSelect" :resourceTypes="options.resourceTypes ?? []" :filterIds="options.filterIds" :restrictIds="options.restrictIds">
