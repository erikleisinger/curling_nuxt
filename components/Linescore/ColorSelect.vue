  ...
  <h2 class="text-md text-bold title q-pa-md text-center">Select rock colors</h2>
    <div class="linescore-confirmation__container">
        <div class="team-option__container">
            ...
            <div class="team__container">
                <div class="avatar-container">
                      <TeamAvatar :teamId="selections.home?.id" :color="selections.homeColor" :viewable="false"/>
                </div>
        ...
        <div class="team-option__container">
            ...
            <div class="team__container">
                <div class="avatar-container">
                    <TeamAvatar :teamId="selections?.away?.id" :color="selections.awayColor" :viewable="false"/>
                </div>
