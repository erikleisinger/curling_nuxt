...
const percentile = computed(() => t.value?.totalStats?.steal_defense_percentile * 100)

const cumulativeAvg = computed(() => (100 - (t.value?.totalStats?.steal_defense * 100)).toFixed(1))
